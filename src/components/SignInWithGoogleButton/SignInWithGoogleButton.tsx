import classes from './SignInWithGoogleButton.module.scss'
    ...
    return (
            <button className={classes.SignInWithGoogleButton} onClick={() => signInWithGoogle()}>
                ...
                <div className={classes.SignInWithGoogleButton__Wrapper}>
                    ...
                    <span className={classes.SignInWithGoogleButton__Contents}>Sign in with Google</span>
                    <Typography style={{ display: 'none' }}>Sign in with Google</Typography>
                </div>
            </button>
    )
}